export const DEFAULT_SETTING_DEFS = [
  ...
  {
    key: "website_about_description",
    value: "",
    type: "textarea",
    group: "website_about",
    label: "Additional Description",
    description: "Extra descriptive content for the about section",
    order: 7,
  },
  {
    key: "website_about_overview",
    value: "",
    type: "textarea",
    group: "website_about",
    label: "Overview",
    description: "Short overview of the platform/organization",
    order: 8,
  },
  {
  ...
  {
    key: "hero_subtitle",
    value: "Start your journey with us today",
    type: "text",
    group: "website_hero",
    label: "Hero Subtitle",
    description: "Supporting heading for the hero section",
    order: 2,
  },
  {
    key: "hero_description",
    value: "We provide the best tools for your success.",
    type: "textarea",
    group: "website_hero",
