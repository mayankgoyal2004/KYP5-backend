...
import CourseCategoriesPage from "./pages/admin/CourseCategories";
import TestsPage from "./pages/admin/Tests";
import TestFormPage from "./pages/admin/TestForm";
import TestDetailPage from "./pages/admin/TestDetail";
import QuestionsPage from "./pages/admin/Questions";
import QuestionFormPage from "./pages/admin/QuestionForm";
