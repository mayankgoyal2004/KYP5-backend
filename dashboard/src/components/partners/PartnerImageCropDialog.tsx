...
export function PartnerImageCropDialog({
  open,
  imageSrc,
  fileName,
  mimeType,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[560px]">
        <DialogHeader>
          <DialogTitle>Crop Partner Logo</DialogTitle>
          <DialogDescription>
            Drag and zoom the image. The uploaded file will be cropped to 135 x
            80 pixels.
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter>
          ...
          <Button onClick={() => void handleConfirm()} disabled={!renderedSize || isExporting}>
            {isExporting ? "Cropping..." : "Use Cropped Logo"}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
