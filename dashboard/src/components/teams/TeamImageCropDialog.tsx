...
const OUTPUT_WIDTH = 338;
const OUTPUT_HEIGHT = 374;
...
export function TeamImageCropDialog({
  open,
  imageSrc,
  fileName,
  mimeType,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[560px]">
        <DialogHeader>
          <DialogTitle>Crop Team Image</DialogTitle>
          <DialogDescription>
            Drag and zoom the image. The uploaded file will be cropped to 338 x
            374 pixels.
          </DialogDescription>
        </DialogHeader>
